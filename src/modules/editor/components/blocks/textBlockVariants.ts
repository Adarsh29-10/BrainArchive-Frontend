...
export const TEXT_BLOCK_VARIANTS = {
  ...
  heading: {
    textareaClassName: `${BASE_TEXTAREA} text-4xl font-bold mt-8 mb-4`,
    placeholder: 'Heading...',
  },

  heading1: {
    textareaClassName: `${BASE_TEXTAREA} text-2xl font-bold mt-6 px-0.5`,
    placeholder: 'Heading1...',
  },

  heading2: {
    textareaClassName: `${BASE_TEXTAREA} text-lg sm:text-xl font-semibold mt-4 px-0.5`,
    placeholder: 'Heading2...',
  },

  paragraph: {
    containerClassName: 'relative mb-2.5 group select-text',
  ...
  quotes: {
    containerClassName: 'relative mb-4 group select-text border-l-2 border-green-200 ml-8 mr-12',
